...
function runMeRightAway() {
  console.log(`Welcome to JS from a function declaration`);
}
...
var fnToRunLater = function() {
  console.log(`Welcome to JS from a function expression`);
};
...
function ourDuty() {
  ...
  console.log(
    `console.log reference: https://developer.mozilla.org/en-US/docs/Web/API/Console/log`
  );
  console.log(
    `debugger reference: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/debugger`
  );
}
